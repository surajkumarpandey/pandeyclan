...
const PandeyI18n = (() => {
  ...
  const DICT = {
    ...
    'tree.download.json': { hi: 'वंश वृक्ष डाउनलोड करें (JSON)' },
    ...
    'footer.credit': { hi: 'निर्माण एवं देखरेख: सूरज कुमार पाण्डेय एवं अशोक कुमार पाण्डेय' },
    'nav.articles': { hi: 'लेख' },
    'articles.title': { hi: 'लेख' },
    'articles.lede': { hi: 'परिवार के सदस्यों द्वारा लिखी यादें, कहानियाँ और लेख।' },
    'articles.write': { hi: 'लेख लिखें' },
    'stats.title': { hi: 'साइट के आँकड़े' },
    'stats.lede': { hi: 'कितने लोगों ने यह पारिवारिक अभिलेख देखा, और वे लगभग कहाँ से देख रहे हैं।' },
    'stats.total': { hi: 'कुल विज़िट' },
    'stats.30': { hi: 'पिछले 30 दिनों में' },
    'stats.7': { hi: 'पिछले 7 दिनों में' },
    'stats.where': { hi: 'विज़िटर कहाँ से आते हैं' },
